...
<body>
  ...
  <table class="table table-striped table-responsive table-primary" id="myTable" style="background-color:white">
    ...
    $result= mysqli_query($conn, $get);
      if(mysqli_num_rows($result) > 0){
            ...
            while($row = mysqli_fetch_array($result)){
                ...
                echo "<td>";
                echo '<a href="view_class.php?sno='.$row['sno'].'"><i class="bi bi-eye-fill"></i></a>';
                echo "</td>";
                echo "<td>";
